return { -- neovim/nvim-lspconfig: Main LSP Configuration
        'neovim/nvim-lspconfig',
        dependencies = {
                { -- mason-org/mason.nvim: package manager for external tooling
        ...
        config = function()
                -- Language Servers are external tools that must be installed separately
                ...
                vim.api.nvim_create_autocmd('LspAttach', {
                        ...
                        callback = function(event)
                                ...
                                -- Goto definition of the word under your cursor. <C-t> to jump back.
                ...
                local servers = {
                        ...
                        pyright = {},
                        rust_analyzer = {},
                        -- for a list of all the pre-configured LSPs
                        --     :help lspconfig-all
                        --
