...
-- [adam] see :help mouse, set mouse=nvi etc.
vim.o.mouse = 'a'
...
-- Diagnostic keymaps
-- this are the key mappings to the lua functions, you can also run it as:
...
-- This is a bootstrap code for neovim lazy plugin manager
...
-- Makes sure that the lazy.nvim is loaded before any other plugin
---@type vim.Option
